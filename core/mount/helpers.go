...
func NeedsMountManager(mounts []Mount) bool {
...
func hasDeviceOption(m Mount) bool {
...
func NeedsNonTemporaryActivation(mounts []Mount) bool {
	for _, m := range mounts {
