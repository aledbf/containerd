...
// (plugins/snapshots/erofs) to indicate a directory is managed by EROFS.
...
//
// This marker-based validation prevents the EROFS differ from incorrectly
// processing layers created by other snapshotters.
